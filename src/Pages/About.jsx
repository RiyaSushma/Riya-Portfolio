...
function About() {
    return (
        ...
        <div className="relative w-full inset-0 about-container h-full" id="about">
            <div className="flex flex-col justify-center w-full items-center gap-20">
                ...
                <section className="grid grid-cols-2 text-black dark:text-white h-full">
                    <motion.div
                    ...
                    >
                        <section
                            id="about"
                            className="flex-1 flex-col text-black dark:text-white items-center justify-center p-3"
                        >
                            <div className="xs:text-justify s:text-left text-justify justify-center xxl:text-lg lg:text-lg md:text-lg sm:text-md s:text-md xs:text-md">
                                <p>
                                    ...
                                    for data structures and algorithms, and a
                                    beginner in Java and Android development.
                                </p>
                                <p>
                                    ...
                                    . Additionally, I have hands-on experience
                                    with Laravel, Remix.js, and data analysis
                                    tools such as NumPy and Pandas. My skills
                                    span full-stack development and data-driven
                                    projects.
                                </p>
                            </div>
                        </section>
                    ...
                    >
                        <section className="relative flex w-full p-3 justify-end">
                            <div className="flex w-96 rounded-xl">
                                <img
                                    src={Section_Image}
                                    className="rounded-xl block max-w-full object-cover"
                                />
                            </div>
                        </section>
                    </motion.div>
